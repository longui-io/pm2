...
/**
 * Changes how `pidusage` captures processes info
 *
 * `true`: Uses the ps binary \
 * `false`: (default) Using proc files
 *
 * @see https://github.com/Unitech/pm2/issues/5045
 */
var pidUsageUsePs = !!process.env.PM2_PIDUSAGE_USE_PS;
...
module.exports = function(God) {
  ...
  God.getMonitorData = function getMonitorData(env, cb) {
    ...
    pidusage(pids, { usePs: pidUsageUsePs }, function retPidUsage(err, statistics) {
